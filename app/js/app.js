		...
		columns: [
			{
				...
				render : function ( data, type, full ) {
					return "<span style='padding-right:25px;' class='label label-flat text-primary-600'>"+full['Product_Company_Number']+" || "+full['Description']+" <img src='img/War-Cross-Mark-PNG-Picture.png'></span>";
				}
			},
			{
				title: "MIN",
				...
				render : function ( data, type, full ) {
					return "<span style='padding-left:25px;' class='label label-flat text-primary-600'> <img style='left:0;' src='img/War-Cross-Mark-PNG-Picture.png'>"+"$"+full['Min_Price']+"</span>";
				}
			},
			{
				title: "MAX",
				...
				render : function ( data, type, full ) {
					return "<span style='padding-left:25px;' class='label label-flat text-primary-600'> <img style='left:0;' src='img/War-Cross-Mark-PNG-Picture.png'>"+"$"+full['Max_Price']+"</span>";
				}
			},
			{
				title: "Promo Price Goal",
				...
				render : function ( data, type, full ) {
					return "<span style='padding-left:25px;' class='label label-flat text-primary-600'><img style='left:0;' src='img/War-Cross-Mark-PNG-Picture.png'>"+full['Promo_Price_Goal']+"</span>";
				}
			}
		],
		colReorder: false,
		...
		columns: [
			{
				...
				render : function ( data, type, full ) {
					return "<span style='padding-right:25px;' style='padding-right:20px;' class='label label-flat text-primary-600'>"+full['Product_Company_Number']+" || "+full['Description']+" <img src='img/War-Cross-Mark-PNG-Picture.png'></span>";
				}
			},
			{
				title: "MIN",
